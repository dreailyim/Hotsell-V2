...
import { z } from 'zod';
import { Upload, Wand2, Loader2, RefreshCw, X, Plus, ChevronsUpDown } from 'lucide-react';
...
export function EditListingForm({ product }: EditListingFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      pickupLocations: product.pickupLocations || (product.pickupLocation ? product.pickupLocation.split(', ') : []),
