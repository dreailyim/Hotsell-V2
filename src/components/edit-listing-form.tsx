  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Button type="submit" size="lg" className="w-full rounded-full bg-gradient-to-r from-blue-500 to-sky-500 text-primary-foreground dark:text-primary-foreground hover:opacity-90 transition-opacity" disabled={isSubmitting}>
