...
exports.onConversationUpdate = exports.createNotificationOnUpdate = exports.onNewMessage = exports.helloWorld = exports.getConversations = void 0;
...
exports.getConversations = functions.region("us-central1").https.onCall((data, context) => {
...
exports.helloWorld = functions.region("asia-east2").https.onCall((data, context) => {
...
exports.createNotificationOnUpdate = functions.region("asia-east2").firestore
