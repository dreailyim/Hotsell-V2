...
exports.getConversations = (0, https_1.onCall)({ region: 'us-central1' }, (request) => {
...
exports.helloWorld = (0, https_1.onCall)({ region: 'asia-east2' }, (request) => {
...
exports.createNotificationOnUpdate = (0, firestore_1.onDocumentUpdated)({ document: '{collectionId}/{docId}', region: 'asia-east2' }, async (event) => {
    var _a, _b, _c;
...
exports.onNewReview = (0, firestore_1.onDocumentCreated)({ document: 'reviews/{reviewId}', region: 'asia-east2' }, async (event) => {
    const snapshot = event.data;
    if (!snapshot) {
...
exports.onConversationUpdate = (0, firestore_1.onDocumentUpdated)({ document: 'conversations/{conversationId}', region: 'asia-east2' }, async (event) => {
    var _a;
    const { conversationId } = event.params;
